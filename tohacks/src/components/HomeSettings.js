...
function HomeSettings() {
    ...
    return (
        <Container className="settings centered">
            <div className="child" style={{backgroundColor: 'lightblue'}}>
                <Grid divided='vertically'>
                    <Grid.Row columns={2} className="sub_container">
                        <Grid.Column>
                            <Header as='h1'
                                style={{ color: "black" }}>Welcome! Please select a few categories that you would like to see news for.</Header>
                        </Grid.Column>
                        <Grid.Column>
